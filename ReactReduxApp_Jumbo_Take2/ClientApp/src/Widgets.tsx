                            ...
                            <div className="box-body">
                                ...
                                <div className="direct-chat-messages">
                                    ...
                                    <div className="direct-chat-msg">
                                        ...
                                        {/* /.direct-chat-info */}
                                        <img className="direct-chat-img" src="assets/dist/img/user1-128x128.jpg" alt="Message User Image" />{/* /.direct-chat-img */}
                                    ...
                                    <div className="direct-chat-msg right">
                                        ...
                                        {/* /.direct-chat-info */}
                                        <img className="direct-chat-img" src="assets/dist/img/user3-128x128.jpg" alt="Message User Image" />{/* /.direct-chat-img */}
                                        <div className="direct-chat-text">
                                ...
                                <div className="direct-chat-contacts">
                                    <ul className="contacts-list">
                                        <li>
                                            <a href="#">
                                                <img className="contacts-list-img" src="assets/dist/img/user1-128x128.jpg" alt="User Image" />
                ...
                <div className="row">
                        ...
                        <div className="box box-widget widget-user-2">
                            ...
                            <div className="widget-user-header bg-yellow">
                                <div className="widget-user-image">
                                    <img className="img-circle" src="assets/dist/img/user7-128x128.jpg" alt="User Avatar" />
                                </div>
                                {/* /.widget-user-image */}
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="box box-widget widget-user">
                            ...
                            <div className="widget-user-image">
                                <img className="img-circle" src="assets/dist/img/user1-128x128.jpg" alt="User Avatar" />
                            </div>
                            <div className="box-footer">
                                <div className="row">
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="box box-widget widget-user">
                            {/* Add the bg color to the header using any of the bg-* classes */}
                            <div className="widget-user-header bg-black" style={{ background: 'url("assets/dist/img/photo1.png") center center' }}>
                                <h3 className="widget-user-username">Elizabeth Pierce</h3>
                                <h5 className="widget-user-desc">Web Designer</h5>
                            </div>
                            <div className="widget-user-image">
                                <img className="img-circle" src="assets/dist/img/user3-128x128.jpg" alt="User Avatar" />
                            </div>
                            <div className="box-footer">
                                <div className="row">
                                    <div className="col-sm-4 border-right">
                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <div className="box box-widget">
                            ...
                            {/* /.box-header */}
                            <div className="box-body">
                                <img className="img-responsive pad" src="assets/dist/img/photo2.png" alt="Photo" />
                  ...
                  <span className="text-muted pull-right">8:03 PM Today</span>
                            ...
                            <div className="box-footer">
                                <form action="#" method="post">
                                    <img className="img-responsive img-circle img-sm" src="assets/dist/img/user4-128x128.jpg" alt="Alt Text" />
