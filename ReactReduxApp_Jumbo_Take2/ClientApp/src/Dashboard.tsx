...
export default class Dashboard extends React.Component {
    ...
    //    if (document.contains(document.getElementById("dashboard-script"))) {
    ...
    render() {
      ...
      //                              {/* chat item */}
      //                              <div className="item">
      //                                  <img src="assets/dist/img/user4-128x128.jpg" alt="user image" className="online" />
      //                                  <p className="message">
      //                                      <a href="fake_url" className="name">
      ...
      //                              {/* chat item */}
      //                              <div className="item">
      //                                  <img src="assets/dist//img/user3-128x128.jpg" alt="user image" className="offline" />
      //                                  <p className="message">
      //                                      <a href="fake_url" className="name">
      ...
      //                              {/* chat item */}
      //                              <div className="item">
      //                                  <img src="assets/dist//img/user2-160x160.jpg" alt="user image" className="offline" />
      //                                  <p className="message">
      //                                      <a href="fake_url" className="name">
      ...
      //                              <div className="row">
      //                                  <div className="col-xs-4 text-center" style={{ borderRight: '1px solid #f4f4f4' }}>
      //                                      <input type="text" className="knob" data-readonly="true" data-width={60} data-height={60} data-fgcolor="#39CCCC" />
